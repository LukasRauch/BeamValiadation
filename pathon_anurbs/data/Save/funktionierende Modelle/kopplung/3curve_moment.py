...
beam_c.add_node_load_moment(t=beam_c.t1(), force=[0, 0, 0], moment=[0,1,0])
...
for step, lam in enumerate(np.linspace(0, 1, 101)[1:]):
    ...
    # beam_c.set_node_load(index=-1, load=[0, F, 0])
