...
penalty_dict = {"displacement_x" : 1e+09,
...
beam_a.add_support(t = beam_a.t0(), penalty = {"displacement_x" : 1e10,
                                                "displacement_y" : 1e10,
                                                "displacement_z" : 1e10, 
                                                "torsion" : 1e6,
                                                "rotation_2" : 1e10,
...
# beam_a.add_support(t = beam_a.t1(), penalty = {"displacement_x" : 1e10,
#                                                 "displacement_y" : 1e6,
#                                                 "displacement_z" : 0, 
#                                                 "torsion" : 1e6,
#                                                 "rotation_2" : 1e10  ,
...
for step, lam in enumerate(np.linspace(0, 1, 201)[1:]):
    beam_a.make_header(step)

    print(' \n##############################')
    print('Force lambda: ', lam )
    F = lam * 12*youngs_modulus*Iy/(5**3)
    M_lam = -2*np.pi*youngs_modulus*Iy/10 * lam /np.sqrt(2)
    print('Moment = ',  M_lam)
