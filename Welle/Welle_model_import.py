...
model = an.Model.open(r'C:\_Masterarbeit\beispiele\Welle\Welle.iga')
...
element_properties.SetValue(CROSS_AREA          , 0.09)     # m²
element_properties.SetValue(YOUNG_MODULUS       , 210)      # kN/m²
element_properties.SetValue(SHEAR_MODULUS       , 79.3)     # kN/m²
element_properties.SetValue(MOMENT_OF_INERTIA_Y , 6.75e-4)  # m4
element_properties.SetValue(MOMENT_OF_INERTIA_Z , 6.75e-4)  # m4
element_properties.SetValue(MOMENT_OF_INERTIA_T , 1.134e-3) # m4
...
# Löser
maximum_iterations = 15 #!! Wenn der Löser nur eine Iteration durchführt erhälst du eine lineare Lösung > Iterationszahl erhöhen!
