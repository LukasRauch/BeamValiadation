...
# ### Randbedingungen 
# element_dirichlet_condition.SetValue(DISPLACEMENT_PENALTY_X             , 1e7)
# element_dirichlet_condition.SetValue(DISPLACEMENT_PENALTY_Y             , 1e7)
# element_dirichlet_condition.SetValue(DISPLACEMENT_PENALTY_Z             , 1e7)
#_________________________________________________________________________________________________________________
