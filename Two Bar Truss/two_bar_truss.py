...
curve = NodeCurveGeometry3D(
    Degree=1, #!! Der Grad der Kurve muss 1 sein damit du Liniensegmente erhälst. Das kann ich dir am Lehrstuhl auch nochmal im CAD zeigen.
    NumberOfNodes=3,
)
...
worksheet = workbook.add_worksheet('Output_1')
...
for i in range(100):
    ...
    f.write("\nVerschiebung X an Knoten 2: " + str(node_2.GetValue(DISPLACEMENT_Z)))
